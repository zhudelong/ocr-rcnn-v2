...
images_path = '/home/zhudelong/dataset/elevator_panel_database/images'
annotations_path = '/home/zhudelong/dataset/elevator_panel_database/annotations'
filtered_image_set = []
button_ratio_list = []
button_size_list = []
image_size_list = []
...
def prepare_dataset(name='all'):
    data_dir = '/home/zhudelong/dataset/elevator_panel_database'
